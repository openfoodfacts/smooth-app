...
curl $PERFECT_PRODUCT_URI > "${SMOOTHIE_PATH}/assets/onboarding/sample_product_data.json"
sudo apt install jq
echo "${SMOOTHIE_PATH}/assets/onboarding/sample_product_data.json"
jq . $PERFECT_PRODUCT_PATH > $PERFECT_PRODUCT_PATH