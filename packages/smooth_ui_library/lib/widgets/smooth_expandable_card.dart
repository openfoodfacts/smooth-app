...
class SmoothExpandableCard extends StatelessWidget {
      ...
      child: Consumer<SingleBooleanModel>(
        builder: (BuildContext context, SingleBooleanModel singleBooleanModel,
          ...
          return AnimatedCrossFade(
            ...
            firstChild: _buildCollapsedWidget(singleBooleanModel, context),
            secondChild: _buildExpandedWidget(singleBooleanModel, context),
  ...
  Widget _buildCollapsedWidget(SingleBooleanModel singleBooleanModel, BuildContext context) {
    return Padding(
      padding:
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                Icon(Icons.keyboard_arrow_down, color: Theme.of(context).accentColor),
              ],
            ),
          ),
        ),
  ...
  Widget _buildExpandedWidget(SingleBooleanModel singleBooleanModel, BuildContext context) {
    return Padding(
      padding:
          const EdgeInsets.only(right: 8.0, left: 8.0, top: 4.0, bottom: 20.0),
      child: Material(
              ...
              GestureDetector(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    Icon(Icons.keyboard_arrow_up, color: Theme.of(context).accentColor),
                  ],
                ),
              ),
              content,
