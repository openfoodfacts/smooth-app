...
class SmoothResponsive {
  ...
  static bool isSmallDevice(BuildContext context) {
    return MediaQuery.widthOf(context).isSmallDevice();
  }

  static bool isSmartphoneDevice(BuildContext context) {
    return MediaQuery.widthOf(context).isSmartphoneDevice();
  }

  static bool isTabletDevice(BuildContext context) {
    return MediaQuery.widthOf(context).isTabletDevice();
  }

  static bool isLargeDevice(BuildContext context) {
    return MediaQuery.widthOf(context).isLargeDevice();
  }
}
...
extension DoubleResponsiveExtensions on double {
  ...
  bool isSmallDevice() {
    return this <= _MAX_SMALL_DEVICE_WIDTH;
  }

  bool isSmartphoneDevice() {
    return this <= _MAX_SMARTPHONE_WIDTH;
  }

  bool isTabletDevice() {
    return this <= _MAX_TABLET_WIDTH;
  }
  ...
  DeviceType get _deviceType {
    if (this <= _MAX_SMALL_DEVICE_WIDTH) {
      return DeviceType.small;
    } else if (this <= _MAX_SMARTPHONE_WIDTH) {
      return DeviceType.smartphone;
    } else if (this <= _MAX_TABLET_WIDTH) {
...
extension BuildContextResponsiveExtensions on BuildContext {
  ...
  DeviceType get deviceType => MediaQuery.widthOf(this)._deviceType;
}
