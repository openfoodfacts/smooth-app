...
class AppLocalizationsCy extends AppLocalizations {
  ...
  @override
  String get send_anonymous_data_toggle_subtitle => 'When enabled, strictly anonymous information regarding feature usage will be sent to the Openâ€¯Foodâ€¯Facts servers, so that we can understand how features are used in order to improve them. Otherwise, a 0 id will be sent.';
  ...
  @override
  String get user_list_empty_label => 'No list available yet!\nPlease start by creating one.';
  ...
  @override
  String get add_basic_details_product_name_warning_translations => 'Before validating, please ensure you only add a translation **if the language is present on the packaging**';
  ...
  @override
  String get guide_nutriscore_v2_where_paragraph1 => 'The Nutri-Score is applied in 7 countries: France, Germany, Belgium, Spain, Luxembourg, the Netherlands and Switzerland.';

  @override
  String get guide_nutriscore_v2_where_paragraph2 => 'Manufacturers have at most **2 years** at the latest after the signature of the decree **to replace** the old calculation with the new one.';
