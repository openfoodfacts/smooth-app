...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Welcome to OpenÂ FoodÂ Facts'**
  String get welcomeToOpenFoodFacts;

  /// Description of Openâ€¯Foodâ€¯Facts organization.
  ///
  /// In en, this message translates to:
  /// **'Openâ€¯Foodâ€¯Facts is a global non-profit powered by local communities.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Sign in to your Openâ€¯Foodâ€¯Facts account to save your contributions'**
  ...
  /// I agree to the Openâ€¯Foodâ€¯Facts is followed by sign_up_page_terms_text
  ///
  /// In en, this message translates to:
  /// **'I agree to the Openâ€¯Foodâ€¯Facts'**
  ...
  /// Please insert the right url here. Go to the Openâ€¯Foodâ€¯Facts homepage, switch to your country and then on the bottom left footer is Terms of use from which the url should be taken
  ///
  /// In en, this message translates to:
  ...
  ///
  /// In en, this message translates to:
  /// **'I\'d like to subscribe to the Openâ€¯Foodâ€¯Facts newsletter (You can unsubscribe from it at any time)'**
  ...
  ///
  /// In en, this message translates to:
  /// **'The code for every Openâ€¯Foodâ€¯Facts product is available on GitHub. You are welcome to reuse the code (it\'s open source) and help us improve it, for everyone, on all the planet.'**
  String get contribute_develop_text;

  /// No description provided for @contribute_develop_text_2.
  ///
  /// In en, this message translates to:
  /// **'You can join the Openâ€¯Foodâ€¯Facts Slack chatroom which is the preferred way to ask questions.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Openâ€¯Foodâ€¯Facts is a global project, containing products from more than 160 countries. Openâ€¯Foodâ€¯Facts is translated into dozens of languages, with constantly evolving content.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Share Openâ€¯Foodâ€¯Facts with your friends'**
  ...
  /// Button label shown on a product, clicking the button opens a card with unanswered product questions, users can answer these to contribute to Openâ€¯Foodâ€¯Facts and gain rewards.
  ///
  /// In en, this message translates to:
  ...
  /// Button description shown on a product, clicking the button opens a card with unanswered product questions, users can answer these to contribute to Openâ€¯Foodâ€¯Facts.
  ///
  /// In en, this message translates to:
  ...
  ///
  /// In en, this message translates to:
  /// **'Sign in to your Openâ€¯Foodâ€¯Facts account to get credit for your contributions'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Create your account and join the Openâ€¯Foodâ€¯Facts community to help build food knowledge all over the world!'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Manage your Openâ€¯Foodâ€¯Facts contributor account.'**
  ...
  /// Accessibility label for images that are outdated (image type may be front/ingredients/nutritionâ€¦)
  ///
  /// In en, this message translates to:
  ...
  ///
  /// In en, this message translates to:
  /// **'Take photos of the packaging to add this product to Openâ€¯Foodâ€¯Facts'**
  ...
  /// A description for accessibility of two images side by side: a Nutri-Score and an Greenâ€¯Score.
  ///
  /// In en, this message translates to:
  /// **'An illustration with unknown Nutri-Score and Greenâ€¯Score'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Preparing a call to the serverâ€¦'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Make Greenâ€¯Score computation more precise with origins, packaging & more'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Tap to answer 3 questions NOW to compute Nutri-Score, Greenâ€¯Score & Ultra-processing (NOVA)!'**
  ...
  ///
  /// In en, this message translates to:
  /// **'**Allowed units** are: kg, g, mg, Âµg, oz, l, dl, cl, ml, fl.oz, fl oz, Ð³, Ð¼Ð³, ÐºÐ³, Ð», Ð´Ð», ÐºÐ», Ð¼Ð», æ¯«å…‹, å…¬æ–¤, æ¯«å‡, å…¬å‡, å¨.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Updating the product on the serverâ€¦'**
  ...
  ///
  /// In en, this message translates to:
  /// **'The Greenâ€¯Score takes into account the origins of the ingredients. Please take a photo of the ingredient list and/or any geographic claim or edit the product, so they can be taken into account.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Open systems settings for Openâ€¯Foodâ€¯Facts'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Sign-in or sign-up to join the Openâ€¯Foodâ€¯Facts community'**
  String get user_profile_subtitle_guest;

  /// User login (when it's an email)
  ///
  /// In en, this message translates to:
  /// **'Openâ€¯Foodâ€¯Facts login: {email}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Hi there, please delete my Openâ€¯Foodâ€¯Facts account: {userId}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Vibrations after executing some actions (barcode decoded, product removedâ€¦).'**
  ...
  ///
  /// In en, this message translates to:
  /// **'When enabled, crash reports are automatically submitted to Openâ€¯Foodâ€¯Facts\' error tracking system, so that bugs can be fixed and thus improve the app.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'When enabled, strictly anonymous information regarding feature usage will be sent to the Openâ€¯Foodâ€¯Facts servers, so that we can understand how features are used in order to improve them. Otherwise, a 0 id will be sent.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Made in Belgium, produced in Brittanyâ€¦'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Rich in fiber, source of ironâ€¦'**
  String get edit_product_form_item_labels_explanation_good_examples_4;

  /// Product edition - Labels - explanation
  ///
  /// In en, this message translates to:
  /// **'Fair trade, Max Havelaarâ€¦'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Input a code (eg: EMB 53062, FR 62.448.034 CE, 84 R 20, 33 RECOLTANT 522â€¦)'**
  ...
  /// Explanation about EMB/ECâ€¦ codes
  ///
  /// In en, this message translates to:
  ...
  ///
  /// In en, this message translates to:
  /// **'If an entry is missing, you can **click on the \"Plus\" icon** to add it (eg: vitamin D, magnesiumâ€¦).'**
  ...
  /// No description provided for @prices_bulk_proof_upload_action.
  ///
  /// In en, this message translates to:
  /// **'Send the proof'**
  String get prices_bulk_proof_upload_action;
  ...
  /// User dev preferences - Disable Greenâ€¯Score - Title
  ///
  /// In en, this message translates to:
  /// **'Exclude Greenâ€¯Score'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Don\'t use symbols Â®, â„¢, Â© or similar'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Input the weight and if needed the quantity (egâ€¯: 4x100g)'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Have a look at this product on Openâ€¯Foodâ€¯Facts: {url}'**
  String share_product_text(String url);

  /// The content which is send, when sharing a 'beauty' product
  ///
  /// In en, this message translates to:
  /// **'Have a look at this product on Openâ€¯Beautyâ€¯Facts: {url}'**
  String share_product_text_beauty(String url);

  /// The content which is send, when sharing a 'pet food' product
  ///
  /// In en, this message translates to:
  /// **'Have a look at this product on Openâ€¯PetFoodâ€¯Facts: {url}'**
  String share_product_text_pet_food(String url);

  /// The content which is send, when sharing a 'products' product
  ///
  /// In en, this message translates to:
  /// **'Have a look at this product on Openâ€¯Productsâ€¯Facts: {url}'**
  String share_product_text_product(String url);

  /// The content which is send, when sharing a product list
  ///
  /// In en, this message translates to:
  /// **'Have a look at my list of products on Openâ€¯Foodâ€¯Facts: {url}'**
  ...
  /// Color Light Brown, Default Openâ€¯Foodâ€¯Facts Color
  ///
  /// In en, this message translates to:
  /// **'Default'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Update the local product database with the latest data from Openâ€¯Foodâ€¯Facts'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Argh! Something went wrongâ€¦ and we couldn\'t load the questions.'**
  ...
  /// Button to select an action in a list (eg: Share, Delete, â€¦)
  ///
  /// In en, this message translates to:
  /// **'Select an action'**
  ...
  /// An action to use the current picture to be used as front/ingredientsâ€¦
  ///
  /// In en, this message translates to:
  /// **'Use asâ€¦'**
  String get photo_viewer_action_use_picture_as;

  /// Message explaining what the three dots (â€¦) button on "More interesting photos" does
  ///
  /// In en, this message translates to:
  /// **'Use this picture asâ€¦'**
  String get photo_viewer_use_picture_as_tooltip;

  /// The title of a dialog to use the current picture as front/ingredientsâ€¦
  ///
  /// In en, this message translates to:
  /// **'Use this picture asâ€¦ ({language})'**
  ...
  ///
  /// In en, this message translates to:
  /// **'The barcode scanned is not supported by Openâ€¯Foodâ€¯Facts!'**
