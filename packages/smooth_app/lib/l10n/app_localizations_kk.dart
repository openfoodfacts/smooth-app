...
class AppLocalizationsKk extends AppLocalizations {
  ...
  @override
  String get open_prices => 'Ашық бағалар';
  ...
  @override
  String get forgot_password_question => 'Құпия сөзді ұмыттыңыз ба?';
  ...
  @override
  String get unknownQuantity => 'Белгісіз саны';
  ...
  @override
  String get packaging_information => 'Қайта өңдеу нұсқаулары';
  ...
  @override
  String get recycling_photo_title => 'Қайта өңдеу нұсқаулары Фотосурет';
  ...
  String no_product_found_explanation(String search) {
    return '\n**\"$search\"**\nбойынша іздеуіңіз ешқандай нәтиже бермеді.';
  }

  @override
  String get no_product_found_try_world_results =>
      'Оның орнына **біздің жаһандық дерекқорымызда** дәл осы іздеуді іске қосқыңыз келе ме?';
  ...
  String get onboarding_welcome_warning =>
      'Кешіріңіз, бұл біздің үлгі өніміміз, оны өңдеу мүмкін емес :)';
  ...
  @override
  String get prices_entry_menu_open_product => 'Өнімнің мәліметтерін қарау';
  ...
  String get dev_mode_openprices_switch_env_title =>
      'prices.openfoodfacts.org (PROD) және сынақ ортасы арасында ауысыңыз';
  ...
  @override
  String get guide_nova_share_link => 'https://world-kk.openfoodfacts.org/nova';
  ...
  String get guide_open_food_facts_share_link =>
      'https://world-kk.openfoodfacts.org/discover';
  ...
  String get guide_open_pet_food_facts_share_link =>
      'https://world-kk.openpetfoodfacts.org/discover';
  ...
  String get guide_open_beauty_facts_share_link =>
      'https://world-kk.openbeautyfacts.org/discover';
  ...
  String get guide_open_products_facts_share_link =>
      'https://world-kk.openproductsfacts.org/discover';
  ...
  String get product_page_for_me_compatibility_score_title =>
      'Менің үйлесімділігім';

  @override
  String product_page_for_me_compatibility_score_value(int value) {
    return '$value% үйлесімді';
  }

  @override
  String get product_page_for_me_compatibility_score_uncomputable =>
      'Үйлесімділік ұпайын есептеу үшін деректер жеткіліксіз.';

  @override
  String product_page_for_me_compatibility_score_unsupported(
    String productType,
  ) {
    return '«$productType» түріндегі көбейтінді үшін ұпай есептеу мүмкін емес.';
  }

  @override
  String get product_page_for_me_attributes_order_importance => 'Маңыздылығы';

  @override
  String get product_page_for_me_attributes_order_evaluation => 'Сәйкестік';
  ...
  @override
  String get prices_explanation_card_title => 'Неліктен бағалар?';

  @override
  String get prices_explanation_card_line1 =>
      '**Open Prices** - бұл бүкіл әлем бойынша өнімдердің бағасын жинау және бөлісу жобасы 🌍. Ашық бағаларды Open Food Facts әзірлейді және қолдайды.';
  ...
  String get folksonomy_explanation_card_title =>
      'Фольксономияның атрибуттары қандай?';

  @override
  String get folksonomy_explanation_card_line1 =>
      'Атрибуттар **кілт-мәнге** негізделген.';

  @override
  String get folksonomy_explanation_card_line2 =>
      'Бұл сипаттарды қолданушылардың кез келген түрі үшін салымшылар жасайды және жібереді.';
  ...
  @override
  String get preferences_prices_metrics_title => 'Ашық баға көрсеткіштері';
  ...
  @override
  String get homepage_scanner_back_to_home_button => 'Үйге оралу';

  @override
  String get homepage_scanner_toggle_camera_tooltip =>
      'Камераны ауыстыру/жасыру';

  @override
  String get homepage_header_barcode_tooltip => 'Штрих-код сканерін көрсету';

  @override
  String get homepage_scanner_overlay_message =>
      '**Штрих-кодты**\nсканерлеу үшін түртіңіз және оның сізге **пайдалы екенін** біліңіз!';

  @override
  String get homepage_scanner_toggle_torch_tooltip => 'Шамды ауыстыру';

  @override
  String get homepage_scanner_banner_start_scanning =>
      'Өнімнің штрих-кодын қарап шығу арқылы оны сканерлеңіз';

  @override
  String homepage_scanner_banner_invalid_barcode(String barcode) {
    return 'Біз келесі штрих-кодты анықтадық: $barcode, бірақ ол жарамсыз сияқты.';
  }

  @override
  String get homepage_horizontal_list_view_more_button => 'Толығырақ…қараңыз';

  @override
  String get homepage_list_most_scanned_title => 'Most scanned products';

  @override
  String get homepage_list_last_scanned_title => 'Соңғы сканерленген өнімдер';
