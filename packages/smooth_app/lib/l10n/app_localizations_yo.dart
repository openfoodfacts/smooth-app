...
class AppLocalizationsYo extends AppLocalizations {
  ...
  @override
  String get scan_navbar_label => 'á»Œlá»jáº¹';
  ...
  String crop_page_too_small_image_message(int expectedMinWidth, int expectedMinHeight, int actualWidth, int actualHeight) {
    return 'Iwá»n to kere julá» ni awá»n piksáº¹li fun gbigbe aworan jáº¹ ${expectedMinWidth}x$expectedMinHeight. Aworan ti o wa lá»wá»lá»wá» jáº¹ ${actualWidth}x$actualHeight.';
  }
  ...
  @override
  String get camera_toggle_flash => 'Tan-an tabi PA filaá¹£i kamáº¹ra naa';
  ...
  @override
  String get category_picker_no_category_found_button => 'ÃˆÃ­ tÃ³ á¹£Ã¡Ã¡jÃº';
