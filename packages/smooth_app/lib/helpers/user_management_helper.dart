...
class UserManagementHelper {
  ...
  static Future<bool> login(User user) async {
    ...
    return rightCredentials && await checkCredentialsInStorage();
  }
  ...
  static Future<bool> checkAndReMountCreds() async {
  ...
  static Future<bool> logout() async {
    ...
    final bool contains = await checkCredentialsInStorage();
    return !contains;
  }
  ...
  static Future<bool> checkCredentialsInStorage() async {
