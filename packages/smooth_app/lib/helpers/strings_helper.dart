...
extension StringExtensions on String {
  ...
  List<int> indexesOf(String charCode, {bool ignoreCase = false}) {
...
class TextHelper {
  ...
  /// From [https://github.com/duocnguyen6799/remove_emoji_input_formatter/blob/main/lib/src/constant.dart]
  ...
  static List<(String, TextStyle?)> getPartsBetweenSymbol({
    ...
    if (highlightedParts.isEmpty) {
      ...
      for (int i = 0; i != highlightedParts.length; i++) {
        ...
        parts.add((
          text.substring(
            subPart.start + symbolLength,
            subPart.end - symbolLength,
          ),
          highlightedStyle,
        ));
        ...
        if (i < highlightedParts.length - 1) {
          parts.add((
            text.substring(
              subPart.end,
              highlightedParts.elementAt(i + 1).start,
            ),
            defaultStyle,
          ));
