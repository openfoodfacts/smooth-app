...
class SimpleInputListSuggestions extends StatelessWidget {
  const SimpleInputListSuggestions(this.onSelected);
...
class _SimpleInputListSuggestionItem extends StatelessWidget {
  const _SimpleInputListSuggestionItem(this.label, this.onSelected);
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: <Widget>[
        ExcludeSemantics(
          child: icons.Sparkles(color: extension.success, size: 18.0),
        ),
