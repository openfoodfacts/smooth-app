...
class _SignUpPageState extends State<SignUpPage> with TraceableClientMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return SmoothScaffold(
      fixKeyboard: true,
      appBar: SmoothAppBar(title: Text(appLocalizations.create_account)),
      body: SafeArea(
        child: AutofillGroup(
          child: Form(
            onChanged: () => setState(() {}),
              ...
              child: ListView(
                ...
                children: <Widget>[
                  ...
                  _SwitchListItem(
                    ...
                    checked: _subscribe,
                    onChanged: (_) => setState(() => _subscribe = !_subscribe),
                  ),
                ],
              ),
            ),
          ...
          child: ElevatedButton(
            ...
            style: ButtonStyle(
              minimumSize: WidgetStateProperty.all<Size>(
                Size(size.width * 0.5, theme.buttonTheme.height + 10.0),
              ),
